...
// Construction de fragments SQL : déplacée dans sql.js pour rester testable
// hors navigateur (db.js tire DuckDB-WASM et apache-arrow). Ré-exportée ici
// pour que les modules qui l'importent depuis db.js continuent de fonctionner.
export { sqlStr, clauseCodes, caseCodes } from "./sql.js";
